...
class SoundMeterAppPurchase extends StatefulWidget {
  @override
  State<SoundMeterAppPurchase> createState() => _SoundMeterAppPurchaseState();
}

class _SoundMeterAppPurchaseState extends State<SoundMeterAppPurchase> {
